...
1. Take raw **RNA–ligand PDB/mmCIF** structures  
...
4. Output:
   ...
   - Predicted binding affinities  
    ...
    run_button = st.button("🚀 Run full pipeline (clean + features + prediction)")
    ...
    if run_button:
        ...
        st.download_button(
            "📥 Download combined features + predictions CSV",
            data=combined_csv,
